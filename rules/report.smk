...
rule generate_report:
    ...
    input:
        ...
        **({
            ...
            # pharokka/phold: NOT read through snakemake.input -- load_phrogs
            # (scripts/report/data_loaders.py) builds the catalog path itself.
            # Without these edges the scheduler may run generate_report before
            # pharokka finishes and emit a report with an empty PHROGS chart, with
